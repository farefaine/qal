...
Tigrinya language model pretraining: data pipeline, tokenizer, training, and inference.

> Phase 1 (data pipeline) is complete. Tokenization, Architecture, Training and Inference are coming next.
